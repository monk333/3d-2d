import { WebGLRenderer, PerspectiveCamera, PointLight, TextureLoader, RepeatWrapping, MeshBasicMaterial, DoubleSide, PlaneGeometry, Mesh, CubeGeometry, FogExp2, MeshPhongMaterial, AxisHelper, OrthographicCamera, Scene, EventDispatcher, Vector3, MOUSE, TOUCH, Quaternion, Spherical, Vector2 } from 'three';
...
class DefaultInteraction extends EventDispatcher {
...
class View2D extends View {
    ...
    initWebGL() {
        ...
        let camera = this.camera = new OrthographicCamera(-SCREEN_WIDTH / 2, SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, -SCREEN_HEIGHT / 2);
